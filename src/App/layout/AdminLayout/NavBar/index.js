...
class NavBar extends Component {
    render() {
        let headerClass = ['navbar', 'no_print', 'pcoded-header', 'navbar-expand-lg', this.props.headerBackColor];
                ...
                <header className={headerClass.join(' ')}>
                    <div className="m-header">
                        ...
                        <a href={DEMO.BLANK_LINK} className="b-brand">
                            <img height="50px" width="50px" alt="" src={logo}>
                            </img>
                    ...
                    <div className="collapse navbar-collapse">
                        <NavLeft user={this.props.user.email.split('.').join('')} project={this.props.project}/>
                        <NavRight url={this.props.url} user_name={this.props.user.displayName} rtlLayout={this.props.rtlLayout} />
                    </div>
                </header>
            </Aux>
        );
