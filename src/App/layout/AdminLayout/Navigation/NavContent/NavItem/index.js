...
class NavItem extends Component {
    ...
    render() {
        ...
        if(this.props.item.external) {
            subContent = (
                <a href={this.props.item.url + this.props.match.params.value} target='_blank' rel='noopener noreferrer'>
            ...
            subContent = (
                <NavLink smooth to={this.props.match.url + this.props.item.url} className="nav-link" exact={true} target={itemTarget}>
                    <NavIcon items={this.props.item}/>
                    <span className='pcoded-mtext'> {itemTitle} </span>
                    <NavBadge layout={this.props.layout} items={this.props.item}/>
                </NavLink>
            );
        }
